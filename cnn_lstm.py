...
checkpoint_filepath = 'data\\models\\cnn_lstm\\m1\\'
# Experiments
engine_name = "m1"

# Results path
results_path = "C:\\Users\\pves\\Documents\\Voxar_Contexto\\Workspace\\Deep_Learning\\Projeto\\deep-learn-anomaly-detection\\data\\results\\cnn_lstm\\"
my_callback = [
    keras.callbacks.ModelCheckpoint(filepath=checkpoint_filepath + 'model.h5', monitor = "val_accuracy", save_best_only = True),
...
model.fit(x_train, y_train, batch_size=32, epochs=5, validation_data=(x_valid, y_valid), verbose=1, callbacks = my_callback)
