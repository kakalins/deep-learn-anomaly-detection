...
models_path = "C:\\Users\\pves\\Documents\\Voxar_Contexto\\Workspace\\Deep_Learning\\Projeto\\deep-learn-anomaly-detection\\data\\models\\lstm\\" + engine_name + "\\"



sequence_leght = 480
path = 'C:\\Users\\pves\\Documents\\Voxar_Contexto\\Workspace\\Deep_Learning\\Projeto\\deep-learn-anomaly-detection\\data\\' + engine_name + ".csv"
...
model = tf.keras.models.load_model(models_path + models[len(models) - 1])

if model == None:
    print("Erro ao baixar modelo")

y_pred = model.predict(x_test)
y_pred = parse_prediction(y_pred, 0.6)
